...
mkdir -p ../data/GDSC/rnaseq
mkdir -p ../data/GDSC/response
...
wget -P ../data/GDSC/response ftp://ftp.sanger.ac.uk/pub/project/cancerrxgene/releases/current_release/GDSC1_fitted_dose_response_24Jul22.xlsx
wget -P ../data/GDSC/response ftp://ftp.sanger.ac.uk/pub/project/cancerrxgene/releases/current_release/GDSC2_fitted_dose_response_24Jul22.xlsx
